...
var AppleLoginProvider = (function (_super) {
    __extends$3(AppleLoginProvider, _super);
    /**
     * @param {?} clientId
     * @param {?} redirectUri
     */
    function AppleLoginProvider(clientId, redirectUri) {
        ...
        _this.loginProviderObj.url = 'https://appleid.cdn-apple.com/appleauth/static/jsapi/appleid/1/en_US/appleid.auth.js';
        return _this;
    }
    /**
     * @return {?}
     ...
     * @return {?}
     */
    AppleLoginProvider.prototype.drawUser = function () {
     ...
     * @return {?}
     */
    AppleLoginProvider.prototype.signOut = function () {
        return new Promise(function (resolve, reject) { });
    };
...
export { SocialLoginModule, AuthService, AuthServiceConfig, SocialUser, LoginProviderClass, LinkedInResponse, FacebookLoginProvider, GoogleLoginProvider, LinkedinLoginProvider, AppleLoginProvider };
